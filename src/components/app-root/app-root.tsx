      ...
      <div class="hero">
        <header>
          ...
          <ul>
            ...
            <li>
              <a href="http://www.linkedin.com/in/alexmerced">LinkedIn</a>
            </li>
            <li>
              <a href="https://www.youtube.com/channel/UCoc4UCEetAt3htM3hV1dQgQ">
                Youtube
              </a>
            </li>
            <li>
              <a href="https://dev.to/alexmercedcoder">Dev.to</a>
            </li>
          </ul>
        </header>
        ...
        <main>
          <div class="buttons">
            <a href="https://lib.alexmercedcoder.com">
              <button>JS Libraries I Created</button>
            </a>

            <stencil-route-link url="/profile/">
              <button>Profile/Projects</button>
            </stencil-route-link>

            <stencil-route-link url="/blog/">
              <button>Contentful Blog</button>
            </stencil-route-link>
            <a href="http://tuts.alexmercedcoder.com/">
              <button>Gatsby Blog</button>
            </a>
