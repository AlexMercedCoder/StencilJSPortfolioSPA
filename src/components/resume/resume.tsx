...
export class Resume {
  ...
  render() {
    return (
     ...
     <h3>EXPERIENCE</h3>
    <h4> Crossfield Digital | 01/2020 – present</h4>
    <h5>Full Stack Developer</h5>
    <p>- Assisted in developing web applications for clients primarily using React, Typescript, Apollo Server, GraphQL</p>
    <p>- Assisted clients in developing refactoring existing CRMs and databases to better suite their needs.</p>
    <p>- Assisted team in testing Android and iOS apps prior to their release.</p>
    
    <h4>General Assembly | 01/2020 - present</h4>
    <h5>Instructor Lead</h5>
    <p>- Delivered existing and custom modules to train students in languages such as Javascript, Python, Ruby and PHP and in frameworks like Express, React, Angular, Ruby on Rails and Django.</p>
